...
import { Plus, Bell, User, Truck, Settings, Calendar } from "lucide-react";
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">Manage your vehicle fleet and track maintenance schedules.</p>
              </div>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">Add your first vehicle</CardTitle>
                      <p className="text-sm text-gray-600">Track your fleet</p>
                    </div>
                  </div>
