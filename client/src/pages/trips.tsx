...
import { Plus, Bell, User, Route, MapPin, Clock } from "lucide-react";
          ...
          <div className="mb-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-gray-600">Plan and track your transportation routes and deliveries.</p>
              </div>
              ...
              <CardHeader className="pb-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <CardTitle className="text-lg">Plan your first trip</CardTitle>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">From: Click to add origin</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <MapPin className="h-4 w-4 text-gray-400" />
                    <span className="text-sm text-gray-600">To: Click to add destination</span>
                  </div>
                  <div className="flex items-center space-x-2">
